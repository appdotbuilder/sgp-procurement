...
export default function ProcurementEdit({ auth, request, venues, statusOptions }: Props) {
    const { data, setData, put, processing, errors } = useForm<ProcurementFormData>({
        tanggal_permintaan: request.tanggal_permintaan,
        nama_venue: request.nama_venue,
        nama_barang: request.nama_barang,
        jumlah_barang: request.jumlah_barang.toString(),
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/procurement/${request.id}`);
    };

    return (
        <AppShell>
            <Head title={`Edit Pengajuan - ${request.nama_barang}`} />
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 mt-2">
                        ID: #{request.id} • Perbarui informasi pengajuan pengadaan barang
                    </p>
                </div>
